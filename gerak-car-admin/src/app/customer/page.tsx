    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-8 max-w-md text-center shadow-2xl">
           ...
           <p className="text-zinc-400 mb-6">This portal is restricted to registered customers only.</p>
           <a href="/" className="bg-blue-500 hover:bg-blue-400 text-white font-medium px-6 py-2 rounded-xl transition-colors inline-block">
             Return Home
           </a>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col relative">
      ...
      <main className="flex-1 relative flex flex-col items-center justify-center bg-zinc-900">
         <div className="text-center z-10 p-6">
            ...
            <p className="text-zinc-400 max-w-sm mx-auto mb-8">The interactive customer map will be placed here in Phase 3.</p>
            
            <div className="bg-zinc-800 border border-zinc-700 p-4 rounded-2xl w-full max-w-md mx-auto shadow-2xl">
                <input type="text" placeholder="Where to?" className="w-full bg-zinc-900 text-white border border-zinc-700 rounded-xl px-4 py-3 mb-3 focus:outline-none focus:border-blue-500" disabled />
                <button className="w-full bg-blue-500 text-white font-semibold py-3 rounded-xl opacity-50 cursor-not-allowed">
                   Search Destination
                </button>
            </div>
         </div>
