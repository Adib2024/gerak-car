    ...
    <div className="relative w-full h-full overflow-hidden flex flex-col bg-black">
      ...
      <div className="absolute top-6 right-6 z-30 pointer-events-auto">
         <form action="/auth/signout" method="post">
            <button type="submit" className="w-12 h-12 bg-black/60 backdrop-blur-xl rounded-full flex items-center justify-center border border-white/10 shadow-[0_10px_20px_rgba(0,0,0,0.5)] text-red-500 hover:bg-red-500 hover:text-white transition-all group">
